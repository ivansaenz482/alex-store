...
export function WhatsappFloat({
  ...
  return (
    <motion.a
      ...
      className="fixed z-50 hidden items-center gap-2 rounded-full bg-[#25D366] px-5 py-4 font-bold text-white shadow-[0_10px_40px_-8px_rgba(37,211,102,0.9)] md:flex"
    >
