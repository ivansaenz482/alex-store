...
export function WhatsappFloat({
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.94 }}
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-4 font-bold text-white shadow-[0_10px_40px_-8px_rgba(37,211,102,0.9)]"
    >
